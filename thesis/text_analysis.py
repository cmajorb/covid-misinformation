...
'''
Train_X, Test_X, Train_Y, Test_Y = model_selection.train_test_split(df['input'],df['output'],test_size=0.25)
...
stats = precision_recall_fscore_support(predictions_SVM, Test_Y)
print("Precision " + str(stats[0][0]) + ", " + str(stats[0][1]))
print("Recall " + str(stats[1][0]) + ", " + str(stats[1][1]))
print("F1 " + str(stats[2][0]) + ", " + str(stats[2][1]))
'''
...
def trainModels(model):
    results = {'0': {'precision': [], 'recall': [], 'f1-score': [], 'support': []}, '1': {'precision': [], 'recall': [], 'f1-score': [], 'support': []}, 'accuracy': [], 'macro avg': {'precision': [], 'recall': [], 'f1-score': [], 'support': []}, 'weighted avg': {'precision': [], 'recall': [], 'f1-score': [], 'support': []}}
